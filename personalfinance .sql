...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-11-2023 a las 14:45:47
...
ALTER TABLE `ahorros`
  ...
  ADD KEY `fk_ahorros_capital1_idx` (`capital_idCapital`);
...
--
ALTER TABLE `tipopresupuesto`
  MODIFY `idTipoPresupuesto` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `ahorros`
  ADD CONSTRAINT `fk_ahorros_capital1` FOREIGN KEY (`capital_idCapital`) REFERENCES `capital` (`idCapital`) ON DELETE NO ACTION ON UPDATE NO ACTION;
