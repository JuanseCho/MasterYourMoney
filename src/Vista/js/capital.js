$(document).ready(function () {
    ...
    //funcion para agregar Ahorros
    const forms = document.querySelectorAll("#form_Agregar_Ahorros");
    ...
    function cargarDatos(response) {
        ...
        if (tablaCapital != null) {
            $("#tabla_Ahorros").dataTable().fnDestroy();
        }
        tablaAhorros = $("#tabla_Ahorros").DataTable({
            data: dataSet,
            search: {
                return: true
            },
        ...
        var total = 0;
        tablaAhorros.column(1).data().each(function (value, index) {
    ...
    $("#tabla_Ahorros").on("click", "#btn_Eliminar_Ahorros", function () {
